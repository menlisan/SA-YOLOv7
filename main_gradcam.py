...
parser.add_argument('--model-path', type=str, default="runs/train1/exp9/weights/best.pt", help='Path to the model')
parser.add_argument('--img-path', type=str, default='E:\MyDataSet\PCB\_detect_imgs\p3.jpg', help='input image path')
...
def get_res_img(mask, res_img):
    ...
    n_heatmat = (heatmap / 255).astype(np.float64)
    res_img = res_img / 255
...
def main(img_path):
    ...
    for target_layer in target_layers:
        ...
        for i, mask in enumerate(masks):
            ...
            output_path = f'{save_path}/{target_layer[:-4]}_cam.jpg'
