...
parser.add_argument('--model-path', type=str, default="runs/train/pcb_SAIoU/weights/best.pt", help='Path to the model')
parser.add_argument('--img-path', type=str, default='E:\MyDataSet\PCB\_detect_imgs\p2.jpg', help='input image path')
