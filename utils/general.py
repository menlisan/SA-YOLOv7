...
def bbox_iou(box1, box2, x1y1x2y2=True, GIoU=False, DIoU=False, CIoU=False, SEIoU=False, AIoU=False, EIoU=False, eps=1e-7):
    ...
    if GIoU or DIoU or CIoU or SEIoU or AIoU or EIoU:
        ...
        #     cw2 = cw ** 2 + eps
        #     ch2 = ch ** 2 + eps
        #     distance_cost = direct_cost * rho2 / c2
